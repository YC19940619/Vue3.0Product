  ...
  <div class="container">
    <div class="header">
      ...
      <div class="keywordSearch">
        ...
        <el-button class="add-btn" type="primary" @click="addStoreVisible = true" v-if="addStorePermission">新增</el-button>
      </div>
    </div>
    <div class="table-container" ref="tableContainer">
      <Table :tableHeight="tableHeight" :storesData="storesData" @delete-role-succ="getData" @change-role-info="getData"></Table>
    </div>
...
import { ViewStoresList } from '@/assets/api/stores'
@Component({
  components: {
    BreadCrumb,
    Pagination,
...
export default class RoleList extends Vue {
  ...
  get addStorePermission () {
    return checkPermission('add_store')
  }
}
</script>
